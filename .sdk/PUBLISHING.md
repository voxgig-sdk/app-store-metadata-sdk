...
|---|---|---|
| `ts/` | @voxgig-sdk/app-store-metadata-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/app-store-metadata-sdk \
      --repository voxgig-sdk/app-store-metadata-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/app-store-metadata-sdk` shows it, and
`npm trust revoke @voxgig-sdk/app-store-metadata-sdk --id=<id>` removes it.

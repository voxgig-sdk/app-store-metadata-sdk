...
// AppStoreMetadata SDK audit feature
...
class AppStoreMetadataAuditFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _emit(AppStoreMetadataContext $ctx, string $outcome): void
    {

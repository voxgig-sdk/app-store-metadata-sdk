...
// AppStoreMetadata SDK netsim feature
...
class AppStoreMetadataNetsimFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _simulate(AppStoreMetadataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AppStoreMetadataContext $ctx, array $applied): void
    {
        $client = $this->client;

...
// AppStoreMetadata SDK proxy feature
...
class AppStoreMetadataProxyFeature extends AppStoreMetadataBaseFeature
{
    ...
    public function init(AppStoreMetadataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AppStoreMetadataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

...
// AppStoreMetadata SDK telemetry feature
...
class AppStoreMetadataTelemetryFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _close(AppStoreMetadataContext $ctx, bool $ok): void
    {

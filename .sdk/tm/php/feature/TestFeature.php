...
// AppStoreMetadata SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AppStoreMetadataTestFeature extends AppStoreMetadataBaseFeature
{
    ...
    public function init(AppStoreMetadataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AppStoreMetadataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AppStoreMetadataParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AppStoreMetadataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AppStoreMetadataContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = AppStoreMetadataParam::call($ctx, $k);

...
// AppStoreMetadata SDK timeout feature
...
class AppStoreMetadataTimeoutFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _with_timeout(AppStoreMetadataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AppStoreMetadataContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
// AppStoreMetadata SDK pipeline test
//
...
{
    private static function utility(): AppStoreMetadataUtility
    {
        return new AppStoreMetadataUtility();
    }
    ...
    private static function ctx(array $over = []): AppStoreMetadataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AppStoreMetadataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AppStoreMetadataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AppStoreMetadataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AppStoreMetadataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AppStoreMetadataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AppStoreMetadataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AppStoreMetadataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AppStoreMetadataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AppStoreMetadataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AppStoreMetadataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AppStoreMetadataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AppStoreMetadataResponse([]),
            'result' => new AppStoreMetadataResult([]),
        ]);
        [, $err] = AppStoreMetadataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AppStoreMetadataSpec([]),
            'response' => null,
            'result' => new AppStoreMetadataResult([]),
        ]);
        [, $err] = AppStoreMetadataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AppStoreMetadataSpec(['step' => 's']),
            'response' => new AppStoreMetadataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AppStoreMetadataResult([]),
        ]);
        [, $err] = AppStoreMetadataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AppStoreMetadataSpec(['step' => 's']),
            'response' => new AppStoreMetadataResponse(self::resp(200, ['v' => 1])),
            'result' => new AppStoreMetadataResult([]),
        ]);
        [, $err] = AppStoreMetadataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AppStoreMetadataSpec(['step' => 's']),
            'response' => new AppStoreMetadataResponse(self::resp(200, ['v' => 2])),
            'result' => new AppStoreMetadataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AppStoreMetadataMakeResponse::call($ctx);
    ...
    {
        $preset = new AppStoreMetadataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AppStoreMetadataSpec([]),
            'response' => new AppStoreMetadataResponse([]),
            'result' => new AppStoreMetadataResult([]),
        ...
        [$got, $err] = AppStoreMetadataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AppStoreMetadataResult([])]);
        [, $err] = AppStoreMetadataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AppStoreMetadataSpec([]), 'result' => null]);
        [, $err] = AppStoreMetadataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AppStoreMetadataSpec(['step' => 's']),
            'result' => new AppStoreMetadataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AppStoreMetadataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AppStoreMetadataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AppStoreMetadataSpec(['step' => 's']),
            'result' => new AppStoreMetadataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AppStoreMetadataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AppStoreMetadataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AppStoreMetadataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AppStoreMetadataSpec([]),
            'result' => new AppStoreMetadataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AppStoreMetadataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AppStoreMetadataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AppStoreMetadataError('boom', 'boom');
        $utility->fetcher = function (AppStoreMetadataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AppStoreMetadataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AppStoreMetadataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AppStoreMetadataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AppStoreMetadataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AppStoreMetadataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AppStoreMetadataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AppStoreMetadataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AppStoreMetadataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AppStoreMetadataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AppStoreMetadataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AppStoreMetadataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AppStoreMetadataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AppStoreMetadataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AppStoreMetadataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AppStoreMetadataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AppStoreMetadataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AppStoreMetadataResult(['ok' => false])]);
        $this->expectException(AppStoreMetadataError::class);
        AppStoreMetadataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AppStoreMetadataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AppStoreMetadataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AppStoreMetadataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AppStoreMetadataBaseFeature();
        $b = new AppStoreMetadataBaseFeature();
        AppStoreMetadataFeatureAdd::call($ctx, $a);
        AppStoreMetadataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AppStoreMetadataBaseFeature
    {
        $f = new AppStoreMetadataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AppStoreMetadataFeatureAdd::call($ctx, self::named_feature('a'));
        AppStoreMetadataFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AppStoreMetadataFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AppStoreMetadataFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AppStoreMetadataFeatureAdd::call($ctx, $replace);
        ...
        AppStoreMetadataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AppStoreMetadataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AppStoreMetadataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AppStoreMetadataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AppStoreMetadataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AppStoreMetadataResponse(['headers' => null]),
            'result' => new AppStoreMetadataResult([]),
        ]);
        AppStoreMetadataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AppStoreMetadataResultBody::call($ctx);

...
// AppStoreMetadata SDK utility: graphql
//
...
class AppStoreMetadataGraphql
{
    ...
    // equivalent.
    public static function body(AppStoreMetadataContext $ctx): mixed
    {
    ...
    public static function errors(AppStoreMetadataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

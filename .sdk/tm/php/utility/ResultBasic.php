...
// AppStoreMetadata SDK utility: result_basic

class AppStoreMetadataResultBasic
{
    public static function call(AppStoreMetadataContext $ctx): ?AppStoreMetadataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AppStoreMetadataError) ? $result->err->msg : (string)$result->err;

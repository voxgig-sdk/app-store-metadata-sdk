...
class AppStoreMetadataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AppStoreMetadataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AppStoreMetadataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AppStoreMetadataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

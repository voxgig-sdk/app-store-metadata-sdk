...
The App Store Metadata API provides reliable access to real-time metadata about iOS apps, including app details, ratings, and reviews.

Learn more about App Store Metadata API at [app-store-metadata-api.kula.app](https://app-store-metadata-api.kula.app).
...
This SDK exposes the API as a small set of **semantic entities** — App — that you

...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/app-store-metadata` | `npm install @voxgig-sdk/app-store-metadata` |
| Python | `voxgig-sdk-app-store-metadata` | `pip install voxgig-sdk-app-store-metadata` |
| PHP | `voxgig-sdk/app-store-metadata` | `composer require voxgig-sdk/app-store-metadata` |
| Golang | `github.com/voxgig-sdk/app-store-metadata-sdk/go` | `go get github.com/voxgig-sdk/app-store-metadata-sdk/go` |
| Ruby | `voxgig-sdk-app-store-metadata` | `gem install voxgig-sdk-app-store-metadata` |
| Lua | `voxgig-sdk-app-store-metadata` | `luarocks install voxgig-sdk-app-store-metadata` |

...
Results: Successful response with app metadata.
...
| --- | --- | --- | --- |
| App | `load` | `GET /api/app/{appId}` | See reference |

## Connect to the API

- Production server: `https://app-store-metadata-api.kula.app`
...
- `app-store-metadata_list`: List records for an entity. No active entity supports this operation.
- `app-store-metadata_load`: Load one record for an entity. Supported entities: `app`.

...
AQL-driven CLI and REPL for the AppStoreMetadata SDK. Positional arguments are
...
```sh
go build -o app-store-metadata-cli ./...
```
...
./app-store-metadata-cli list app
./app-store-metadata-cli load 1 app
./app-store-metadata-cli load '{id:1}' app

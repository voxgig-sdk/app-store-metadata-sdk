...
func registerSDKWords(r *eng.Registry, client *sdk.AppStoreMetadataSDK) {
...
func runOp(client *sdk.AppStoreMetadataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

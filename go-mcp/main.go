// Command AppStoreMetadata-mcp is an MCP server exposing the AppStoreMetadata
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AppStoreMetadata_list  — list records of an entity
//	AppStoreMetadata_load  — load a single record of an entity
//

...
type Args struct {
	Entity string         `json:"entity" jsonschema:"app"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AppStoreMetadataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "app-store-metadata_list",
		Description: "List records from AppStoreMetadata. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "app-store-metadata_load",
		Description: "Load a single record from AppStoreMetadata. " +
...
func runOp(client *sdk.AppStoreMetadataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AppStoreMetadataSDK, name string) (sdk.AppStoreMetadataEntity, error) {

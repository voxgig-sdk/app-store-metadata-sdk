...
type AppStoreMetadataSDK struct {
	Mode     string
...
func (sdk *AppStoreMetadataSDK) OptionsMap() map[string]any {
...
func (sdk *AppStoreMetadataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AppStoreMetadataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AppStoreMetadataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AppStoreMetadataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AppStoreMetadataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AppStoreMetadataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AppStoreMetadataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AppStoreMetadataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AppStoreMetadataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AppStoreMetadataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AppStoreMetadataSDK {
	...
	sdk := NewAppStoreMetadataSDK(sdkopts)
	sdk.Mode = "test"

...
type AppEntity struct {
	name    string
	client  *core.AppStoreMetadataSDK
...
func NewAppEntity(client *core.AppStoreMetadataSDK, entopts map[string]any) *AppEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppEntity) GetName() string { return e.name }
...
func (e *AppEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AppEntity) Deleted() bool {
	return e.deleted
}


func (e *AppEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAppEntity(e.client, opts)
}

func (e *AppEntity) Data(args ...any) any {
...
func (e *AppEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an App; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AppEntity) DataTyped(data ...App) App {
	if len(data) > 0 {
		return typedFrom[App](e.Data(asMap(data[0])))
	}
	return typedFrom[App](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through App (all fields
// optional at the wire level).
func (e *AppEntity) MatchTyped(match ...App) App {
	if len(match) > 0 {
		return typedFrom[App](e.Match(asMap(match[0])))
	}
	return typedFrom[App](e.Match())
}
...
func (e *AppEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AppEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AppLoadMatch and returns an App. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AppEntity) LoadTyped(reqmatch AppLoadMatch, ctrl map[string]any) (App, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return App{}, err
	}
	return typedFrom[App](res), nil
}



func (e *AppEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AppEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AppEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AppEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AppEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

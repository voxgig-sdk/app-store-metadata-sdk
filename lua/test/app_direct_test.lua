...
describe("AppDirect", function()
  it("should direct-load-app", function()
    local setup = app_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-app", setup.live and "live" or "unit")
...
function app_direct_setup(mockres)

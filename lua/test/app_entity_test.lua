...
describe("AppEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set APPSTOREMETADATA_TEST_APP_ENTID JSON to run live")
      return
    end
...
function app_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("APPSTOREMETADATA_TEST_APP_ENTID")

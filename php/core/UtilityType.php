...
// AppStoreMetadata SDK utility type

class AppStoreMetadataUtility
{
    ...
    public static function copy(AppStoreMetadataUtility $src): AppStoreMetadataUtility
    {
        $u = new AppStoreMetadataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

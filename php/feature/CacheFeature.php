...
// AppStoreMetadata SDK cache feature
...
class AppStoreMetadataCacheFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _through(AppStoreMetadataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

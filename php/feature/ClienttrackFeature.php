...
// AppStoreMetadata SDK clienttrack feature
...
class AppStoreMetadataClienttrackFeature extends AppStoreMetadataBaseFeature
{
    ...
    public function PostConstruct(AppStoreMetadataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AppStoreMetadata-SDK';

...
// AppStoreMetadata SDK debug feature
...
class AppStoreMetadataDebugFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _finish(AppStoreMetadataContext $ctx, bool $ok): void
    {

...
// AppStoreMetadata SDK idempotency feature
...
class AppStoreMetadataIdempotencyFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _mutating(AppStoreMetadataContext $ctx): bool
    {

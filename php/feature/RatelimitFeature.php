...
// AppStoreMetadata SDK ratelimit feature
...
class AppStoreMetadataRatelimitFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _acquire(AppStoreMetadataContext $ctx): void
    {
    ...
    private function _track(AppStoreMetadataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

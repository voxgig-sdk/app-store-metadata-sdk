...
// AppStoreMetadata SDK rbac feature
...
class AppStoreMetadataRbacFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _required(AppStoreMetadataContext $ctx): ?string
    {
    ...
    private function _reject(AppStoreMetadataContext $ctx, string $required): void
    {
    ...
    private function _track(AppStoreMetadataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

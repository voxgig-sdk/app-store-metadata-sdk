...
// AppStoreMetadata SDK streaming feature
...
class AppStoreMetadataStreamingFeature extends AppStoreMetadataBaseFeature
{
    ...
    private function _iterate(AppStoreMetadataResult $result): \Generator
    {
    ...
    private function _streamable(AppStoreMetadataContext $ctx): bool
    {

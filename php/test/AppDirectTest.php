...
class AppDirectTest extends TestCase
{
    public function test_direct_load_app(): void
    {
        $setup = app_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-app", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

...
// AppStoreMetadata SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AppStoreMetadataSDK::test)
...
{
    private const SDK_CLASS = 'AppStoreMetadataSDK';
    ...
    private const SDK_BASE = 'appstoremetadata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../appstoremetadata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

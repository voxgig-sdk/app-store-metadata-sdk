...
// AppStoreMetadata SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AppStoreMetadataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AppStoreMetadataOmni::structfix($now, Struct::undef()))
                        !== json_encode(AppStoreMetadataOmni::structfix($val, Struct::undef()))) {

...
// AppStoreMetadata SDK utility: fetcher

class AppStoreMetadataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AppStoreMetadataSDK/1.0)';
    ...
    public static function call(AppStoreMetadataContext $ctx, string $fullurl, array $fetchdef): array
    {

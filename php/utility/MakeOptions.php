...
// AppStoreMetadata SDK utility: make_options

class AppStoreMetadataMakeOptions
{
    ...
    public static function call(AppStoreMetadataContext $ctx): array
    {
        ...
        //
        // `AppStoreMetadataSchema::optspec()` is built from the model:
        ...
        $optspec = AppStoreMetadataSchema::optspec();

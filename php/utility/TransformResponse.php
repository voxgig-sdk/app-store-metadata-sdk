...
// AppStoreMetadata SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AppStoreMetadataTransformResponse
{
    public static function call(AppStoreMetadataContext $ctx): mixed
    {
        ...
        $transform = AppStoreMetadataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

# AppStoreMetadata Python SDK



The Python SDK for the AppStoreMetadata API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.App()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/app-store-metadata-sdk/releases)) or
...
```python
client = AppStoreMetadataSDK.test(testopts, sdkopts)
```
...
```
py/
├── appstoremetadata_sdk.py         -- Main SDK module
...
The main module (`appstoremetadata_sdk`) exports the SDK class.

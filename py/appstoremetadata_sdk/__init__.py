...
from appstoremetadata_sdk.utility import register

# Load features
from appstoremetadata_sdk.feature.base_feature import AppStoreMetadataBaseFeature
from appstoremetadata_sdk.features import _has_feature, _make_feature
...
class AppStoreMetadataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AppStoreMetadataUtility()
        self._utility = utility

        from appstoremetadata_sdk.config import shared_config
    ...
    def get_utility(self):
        return AppStoreMetadataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AppStoreMetadataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def App(self, data=None) -> "AppEntity":
        ...
        from appstoremetadata_sdk.entity.app_entity import AppEntity

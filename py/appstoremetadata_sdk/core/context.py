...
from appstoremetadata_sdk.core.helpers import get_ctx_prop, to_map
...
class AppStoreMetadataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AppStoreMetadataControl()
        ...
        if isinstance(sp, AppStoreMetadataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AppStoreMetadataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AppStoreMetadataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AppStoreMetadataOperation({})
    ...
    def make_error(self, code, msg):
        return AppStoreMetadataError(code, msg, self)

# AppStoreMetadata SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AppStoreMetadataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AppStoreMetadataSDK(...) and AppStoreMetadataSDK.test(...) become
#      AppStoreMetadataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "appstoremetadata_sdk"
_SDK_CLASS = "AppStoreMetadataSDK"

# AppStoreMetadata SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from appstoremetadata_sdk import AppStoreMetadataSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"AppStoreMetadataSDK": AppStoreMetadataSDK, "os": os}
        try:

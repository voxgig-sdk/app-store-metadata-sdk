# AppStoreMetadata Ruby SDK Reference

Complete API reference for the AppStoreMetadata Ruby SDK.
...
#### `AppStoreMetadataSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
result, err = client.App.load({ "id" => "app_id" })
```

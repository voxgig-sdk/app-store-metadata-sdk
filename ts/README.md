# AppStoreMetadata TypeScript SDK



The TypeScript SDK for the AppStoreMetadata API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.App()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `AppStoreMetadataSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `AppStoreMetadataSDK.test(testopts?, sdkopts?)` | `AppStoreMetadataSDK` | Create a test-mode client. |
...
| `client` | `client(): AppStoreMetadataSDK` | Return the parent SDK client. |
...
app-store-metadata/
├── src/
│   ├── AppStoreMetadataSDK.ts        # Main SDK class

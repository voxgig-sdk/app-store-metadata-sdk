...
(0, node_test_1.describe)('AppDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AppStoreMetadataSDK({
    ...
    (0, node_test_1.test)('direct-load-app', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-app', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.APP_STORE_METADATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AppStoreMetadataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['APP_STORE_METADATA_TEST_APP_ENTID'];
    ...
    const client = new __1.AppStoreMetadataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AppDirect.test.js.map
...
function envOverride(m) {
    if ('TRUE' === process.env.APP_STORE_METADATA_TEST_LIVE ||
        'TRUE' === process.env.APP_STORE_METADATA_TEST_OVERRIDE) {
    ...
    m.APP_STORE_METADATA_TEST_EXPLAIN = process.env.APP_STORE_METADATA_TEST_EXPLAIN || m.APP_STORE_METADATA_TEST_EXPLAIN;
    return m;
}

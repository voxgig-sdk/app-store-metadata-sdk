...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.APPSTOREMETADATA_TEST_LIVE ||
    'TRUE' === process.env.APPSTOREMETADATA_TEST_OVERRIDE
  ) {
  ...
  m.APPSTOREMETADATA_TEST_EXPLAIN = process.env.APPSTOREMETADATA_TEST_EXPLAIN || m.APPSTOREMETADATA_TEST_EXPLAIN
